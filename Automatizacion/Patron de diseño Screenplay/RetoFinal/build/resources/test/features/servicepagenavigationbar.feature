Feature: utility navigation bar
  ...
  Scenario:
  It will be validated that the anchor element "Booking.com" redirects to the home page.
  ...
  Scenario:
  It will be validated that the anchor element "Booking.com" redirects to the Alquileres de coche page.
    Given the user is on the home page of the application
  ...
  It will be validated that the anchor element "Booking.com" redirects to the Atracciones turisticas page.
    Given the user is on the home page of the application
